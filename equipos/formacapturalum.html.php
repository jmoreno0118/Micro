   ...
   ?>
    <form id="medsform" name="medsform" action="" method="post">
      ...
      <div>
         ...
         <input type="text" name="<?php htmlout($name); ?>" id="<?php htmlout($name); ?>" value="<?php if(isset($luminometro))htmlout($luminometro[$name]); ?>">
      </div>
      <br>
      <?php endforeach?>
      ...
      <?php if(isset($luminometro)): ?>
        <?php $intervalos = json_decode($luminometro['intervalos'], true); 
        var_dump($intervalos); ?>
      <?php endif; ?>
      <div id="intervalos">
        <div>
          <label for="rango[]">Rango:</label><input name="rango[0]" id="rango[0]" value="<?php if(isset($luminometro)) htmlout($intervalos[0]['Rango']); ?>" required>
          <label for="fcorreccion1[]">Factor de Corrección 1:</label><input name="fcorreccion1[0]" id="fcorreccion1[0]" value="<?php htmlout((isset($luminometro)) ? $intervalos[0]['Correccion1'] : "0"); ?>" required>
          <label for="fcorreccion2[]">Factor de Corrección 2:</label><input name="fcorreccion2[0]" id="fcorreccion2[0]" value="<?php htmlout((isset($luminometro)) ? $intervalos[0]['Correccion2'] : "0"); ?>" required>
        </div>
        <?php if(isset($luminometro)): ?>
