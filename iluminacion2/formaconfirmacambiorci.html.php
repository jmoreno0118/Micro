	   ...
	   <form action="?" method="post">.
		 ...
		 <p>
		  ...
		  <?php for ($i=0; $i<count($puestos); $i++) :?>
			<input type="hidden" name="descpuestos[<?php echo $i; ?>][puesto]" value="<?php htmlout($puestos[$i]); ?>">
			<input type="hidden" name="descpuestos[<?php echo $i; ?>][numtrabajadores]" value="<?php htmlout($numtrabajadores[$i]); ?>">
			<input type="hidden" name="descpuestos[<?php echo $i; ?>][actividades]" value="<?php htmlout($actividades[$i]); ?>">
		  <?php endfor; ?>	  
