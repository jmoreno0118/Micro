  ...
  <div id="cuerpoprincipal"> 
   ...
   <form action="?" method ="post">
    <div>
	  ...
	  <input type="hidden" name="accion" value="nuevopunto">
	  <input type="submit" value="Agregar un nuevo punto">
	</div>
   </form>
...
<!--   <form action="?" method="post">
  ...
  <form action="?" method="post">
   <div>
     ...
     <input type="submit" name="boton" value="Regresa a rec. ini.">
   </div>
  </form>
<!--  <p><a href="?volverci&amp;idot=<?php htmlout($idot); ?>">regresar a reconicimientos iniciales</a></p> -->
